...
import (
	...
	apr "bytetrade.io/web3os/tapr/pkg/generated/informers/externalversions/apr"
...
func (f *sharedInformerFactory) Apr() apr.Interface {
	return apr.New(f, f.namespace, f.tweakListOptions)
}
