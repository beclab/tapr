...
func init() {
	...
	InfisicalDBUser = GetenvOrDefault("MONGO_USER", InfisicalDBUser)
	InfisicalDBName = GetenvOrDefault("MONGO_DB", InfisicalDBName)
	InfisicalDBAddr = os.Getenv("MONGO_ADDR")
...
func InsertKsUser(ctx context.Context, mongo *MongoClient, username, email, password string) error {
